...
{	
  ...
  var previewSP : SerializedProperty;
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    previewSP = serObj.FindProperty ("preview");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (previewSP, new GUIContent("Preview"));
    if (previewSP.boolValue)
